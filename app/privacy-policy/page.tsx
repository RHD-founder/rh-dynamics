  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          If you have any questions about this Privacy Policy, please contact us at <Link href="mailto:founder@rh-dynamics.software" className="text-blue-600 hover:underline">founder@rh-dynamics.software</Link>.
        </p>
      </div>
    </div>
  );
